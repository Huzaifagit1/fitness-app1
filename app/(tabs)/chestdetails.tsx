...
const imageMap: Record<string, any> = {
    chest1: require("./assets/images/chest1.gif"),
    chest2: require("./assets/images/chest2.gif"),
    chest3: require("./assets/images/chest3.gif"),
    chest4: require("./assets/images/chest4.gif"),
    chest5: require("./assets/images/chest5.gif"),
    chest6: require("./assets/images/chest5.gif"),
};
...
export default function ExerciseDetails() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-100 p-5">
            <View className="items-center bg-white p-2 rounded-2xl shadow-lg">
                <Text
                    style={{
                        fontSize: hp(2.5),
                ...
                <Image
                    ...
                    style={{ height: hp(55), width: hp(45), borderRadius: hp(5) }}
