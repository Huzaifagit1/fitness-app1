...
const imageMap: Record<string, any> = {
    bicep1: require("./assets/images/bicep1.gif"),
    bicep2: require("./assets/images/bicep2.gif"),
    bicep3: require("./assets/images/bicep3.gif"),
    bicep4: require("./assets/images/bicep4.gif"),
    bicep5: require("./assets/images/bicep5.gif"),
    bicep6: require("./assets/images/bicep6.gif"),   
};
    ...
    return (
        ...
        <View className="items-center bg-white p-5 rounded-2xl shadow-lg">
           ...
           <Text 
                ...
                {name || "Exercise Name"}
            </Text> <Text className="text-lg text-gray-600 mt-2 text-center leading-relaxed px-3">
