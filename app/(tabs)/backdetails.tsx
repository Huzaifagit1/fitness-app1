...
const imageMap: Record<string, any> = {
    back1: require("./assets/images/back1.gif"),
    back2: require("./assets/images/back6.gif"),
    back3: require("./assets/images/back3.gif"),
    back4: require("./assets/images/back4.gif"),
    back5: require("./assets/images/back5.gif"),
    back6: require("./assets/images/back2.gif"),   
};
