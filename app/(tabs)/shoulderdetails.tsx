...
const imageMap: Record<string, any> = {
    shoulder1: require("./assets/images/shoulder1.gif"),
    shoulder2: require("./assets/images/shoulder22.gif"),
    shoulder3: require("./assets/images/shoulder3.gif"),
    shoulder4: require("./assets/images/shoulder4.jpg"),
    shoulder5: require("./assets/images/shoulder5.gif"),
    shoulder6: require("./assets/images/shoulder6.gif"),   
};  
